...
Random Forest has the lowest out of sample error rate
```{r}
...
Based on accuracy, which is how well the model predicts the correct outcome, and equally weighs false positives and negatives, Random Forest is best, edging out Generalized Boosted Regression.  Recursive partitioning does not fare well compared to the other algorthms.  We'll explore in further detail the first two.
...
Specificity is how well the model performs in distinguishing true vs false negatives.  Looking at each class.  The higher performing model matches favorably to the alternative.
